      ...
      <div className="bg-[#F9FAFB] flex gap-8 p-10">
        <div className="flex flex-col gap-6 w-[240px]">
          ...
          <ul className="flex flex-col">
            <li
              onClick={() => handleTabToggle("accountDetails")}
              className={`flex items-center gap-4 px-4 py-2.5 rounded-md cursor-pointer ${
                tab === "accountDetails" ? "bg-zinc-200" : "bg-transparent"
              }`}
            >
            ...
            <li
              ...
              className={`flex items-center gap-4 px-4 py-2.5 rounded-md cursor-pointer ${
                tab === "security" ? "bg-zinc-200" : "bg-transparent"
              }`}
            >
              <img src={lock} alt="" />
            ...
            <div>
              ...
              <div className="mt-8">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h5 className="text-[#09090B] font-medium">
                      Profile picture
                    </h5>
                  ...
                  <form className="mt-12 grid grid-cols-1 lg:grid-cols-2 md:gap-x-10 lg:gap-x-10 xl:gap-x-14 gap-y-5 md:gap-y-7 pb-9">
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        placeholder="John"
                        className="px-4 py-2 rounded-md border border-[#E4E4E7] outline-none"
                      />
                    ...
                    <div className="flex flex-col gap-1">
                      ...
                      <input
                        ...
                        name="emailAddress"
                        id="emailAddress"
                        value={accountFormData.emailAddress}
                        onChange={handleAccountFormChange}
                        placeholder="johndoe@gmail.com"
                        className="px-4 py-2 rounded-md border border-[#E4E4E7] outline-none"
                      />
                      {accountErrors.emailAddress && (
                        <div className="text-red-600 text-sm">
                          {accountErrors.emailAddress}
                        </div>
                      )}
